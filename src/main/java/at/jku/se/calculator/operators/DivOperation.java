...
*/
public class DivOperation implements ICalculationOperation {
private static final Logger LOGGER = LogManager.getLogger(DivOperation.class);

@OverRide
public String calculate(String txt) {
LOGGER.info("Div Operation executed: " + txt);
